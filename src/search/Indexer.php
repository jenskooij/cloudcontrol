...
use CloudControl\Cms\search\indexer\InverseDocumentFrequency;
use CloudControl\Cms\search\indexer\TermCount;
use CloudControl\Cms\search\indexer\TermFieldLengthNorm;
use CloudControl\Cms\search\indexer\TermFrequency;
